...
export {default as TicketListView} from './ticket-list';
export {default as TicketDetailView} from './ticket-detail';
export {default as CustomerListView} from './customer-list';
export {default as CustomerDetailView} from './customer-detail';
